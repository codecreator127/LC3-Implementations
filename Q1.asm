...
;		
MyXOR	AND R1, R1, 0	; put the value in R7 in stack
		ADD R1, R7, 0
		JSR Push

		AND R1, R1, 0	; put the value in R5 in stack
		ADD R1, R5, 0
		JSR Push
		...
		JSR Pop
		AND R5, R5, 0
		ADD R5, R5, R1 ; recover R5
		
		JSR Pop
		AND R7, R7, 0
		ADD R7, R7, R1 ; recover R7
...
;
MyMULT	AND R1, R1, 0	; put the value in R7 in stack
		ADD R1, R7, 0
		JSR Push
